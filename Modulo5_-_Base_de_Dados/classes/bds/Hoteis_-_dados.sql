...
insert into organização (numero_cliente, Nome_Contacto, Ramo_Actividade) values (2, null, 'Ensino');
insert into organização (numero_cliente, Nome_Contacto, Ramo_Actividade) values (4, 'Evaristo', 'Internacional');
insert into organização (numero_cliente, Nome_Contacto, Ramo_Actividade) values (6, null, 'Defesa');
insert into organização (numero_cliente, Nome_Contacto, Ramo_Actividade) values (8, 'Joao', 'Governação');
insert into organização (numero_cliente, Nome_Contacto, Ramo_Actividade) values (10, null, 'Transportes');
insert into organização (numero_cliente, Nome_Contacto, Ramo_Actividade) values (13, null, 'Alimentar');
